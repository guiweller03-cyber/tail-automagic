...
export function AssistenteIA() {
  ...
  return (
    <div className="flex flex-col h-[calc(100dvh-8rem)] gap-2">
      ...
      <div className={`card-soft overflow-hidden flex flex-col min-h-[220px] ${mobilePanel !== "conversas" ? "max-lg:hidden" : ""}`}>
      ...
      <div className={`card-soft flex flex-col overflow-hidden ${mobilePanel !== "chat" ? "max-lg:hidden" : ""}`}>
      ...
      <div className={`space-y-4 overflow-y-auto scrollbar-thin ${mobilePanel !== "insights" ? "max-lg:hidden" : ""}`}>
        ...
        <div className="card-soft p-4">
          <h3 className="font-semibold text-sm flex items-center gap-2">
            <AlertTriangle className="size-4 text-accent" /> Alertas ativos ({alertasAtivos.length})
          </h3>
